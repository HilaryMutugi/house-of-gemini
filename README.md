...
1. Create a GitHub account and a new public repository, for example `house-of-gemini`.
2. Upload every file and the entire `assets` folder to the repository.
3. Open the repository's **Settings**.
4. Select **Pages**.
5. Under **Build and deployment**, choose **Deploy from a branch**.
6. Select the `main` branch and `/ (root)`, then save.
7. GitHub will show the public website address after a few minutes.

Your address will look like:

`https://YOUR-USERNAME.github.io/house-of-gemini/`
